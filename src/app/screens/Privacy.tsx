...
export default function PrivacyPolicy() {
  return <div className="screen-privacy">
    ...
    <p>
      ...
      third party libraries. They handle tasks like accessing the camera / webcam
      and managing the state of the application. As far as I can tell none of them
      send any data back home.
    </p>
    ...
    <p>
      ...
      Their <a href="https://docs.github.com/en/github/site-policy/github-privacy-statement#github-pages">
        privacy policy
      </a> states (last checked 2020-07-10):
      <br />
      <code>
    ...
    <h2>Contact</h2>
    <span>
      If you notice any errors in this document or
      any activity that is not in line with this policy
      please send an email with your findings to me (
